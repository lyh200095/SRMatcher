...
TRAIN_BASE_PATH = "data/datasets/megadepth/index"
cfg.DATASET.TRAINVAL_DATA_SOURCE = "MegaDepth"
cfg.DATASET.TRAIN_DATA_ROOT = "data/datasets/megadepth/train"
...
TEST_BASE_PATH = "data/datasets/megadepth/index"
cfg.DATASET.TEST_DATA_SOURCE = "MegaDepth"
cfg.DATASET.VAL_DATA_ROOT = cfg.DATASET.TEST_DATA_ROOT = "data/datasets/megadepth/test"
...
cfg.TRAINER.N_SAMPLES_PER_SUBSET = 30

cfg.DATASET.MGDPT_IMG_RESIZE = 704  # for training on 11GB mem GPUs
